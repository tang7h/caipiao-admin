  ...
  <div class="stage">
    <div ng-show="pages[0].status" class="page table" id="page-fucai">
      ...
      <div class="row data bar {{bar.status}}" style="top: {{dataT.id*48}}px">
        ...
        <div class="cell edit">
          <svg class="icon" ng-click="editComplete(url.editFucai)" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"/></svg>
          <svg class="icon md-dark" ng-click="bar.hide()" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>
        </div>
      </div>
    ...
    <div ng-show="pages[1].status" class="page table" id="page-ticai">
      ...
      <div class="row data bar {{bar.status}}" style="top: {{dataT.id*48}}px">
        ...
        <div class="cell time"> <input type="text" ng-model="dataT.Time"> </div>
        <div class="cell edit">
          <svg class="icon" ng-click="editComplete(url.editTicai)" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"/></svg>
          <svg class="icon md-dark" ng-click="bar.hide()" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>
        </div>
      </div>
    ...
    <div ng-show="pages[2].status" class="page setting" id="page-setting" spellcheck="false">
      <div class="group">
        ...
        <div class="setting-item">
          ...
          <input type="text" ng-model="settingsFucai.next">
        </div>
        <div class="setting-item">
      ...
      <div class="group">
        ...
        <div class="setting-item">
          <div class="item-name">开奖倒计时</div>
          <input type="text" ng-model="settingsTicai.next">
        </div>
        <div class="setting-item">
          <div class="item-name">推介号</div>
